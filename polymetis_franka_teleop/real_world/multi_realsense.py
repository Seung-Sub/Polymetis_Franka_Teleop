"""
MultiRealsense - Multi-camera manager for Intel RealSense cameras.

Based on UMI's MultiUvcCamera pattern, adapted for Intel RealSense cameras.
Manages multiple SingleRealsense instances with synchronized control.

Features:
- Manages multiple SingleRealsense processes
- Synchronized start/stop operations
- Per-camera configuration support
- Video recording with per-camera paths
- Intrinsics and depth scale access
